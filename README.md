...
note: the AI/docker/selfsigned.key file is not in the repo as it is in .gitignore, i created the file directly in the ec2 machine as it is not in the repo
